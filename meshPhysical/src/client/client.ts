...
import { BackSide, CubeTexture, CubeTextureLoader, DoubleSide, FrontSide, PointLight } from 'three';

const scene = new THREE.Scene();
scene.add(new THREE.AxesHelper(5))

const light = new PointLight(0xffffffff, 2)
...
//dung de tao khong gian co anh da chieu
const pmremGenerator = new THREE.PMREMGenerator(renderer)

// import 4 mat anh da chieu
